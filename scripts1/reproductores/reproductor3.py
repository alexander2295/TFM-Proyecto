...
# Función para verificar o crear la tabla de configuración
...
def analizar_generos(videos):
    conteo_generos = defaultdict(lambda: {'vistas': 0, 'likes': 0, 'cantidad_videos': 0, 'titulos': []})
    for video in videos:
        try:
            ...
            logger.error(f"Falta una clave en los datos del video: {e}")
